...
def days(event_types):
    return {
        datetime(2017, 10, 26, 0, 0): {'event_types': event_types},
        datetime(2017, 10, 27, 0, 0): {'event_types': event_types},
        datetime(2017, 10, 28, 0, 0): {'event_types': event_types},
        datetime(2017, 10, 29, 0, 0): {'event_types': event_types},
    }
